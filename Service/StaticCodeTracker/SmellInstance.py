class SmellInstance:
    ...
    def __hash__(self):
        return hash(self.className) + hash(self.methodName) + hash(self.field) + hash(self.sourcePath) + hash(self.smellAbbv) + hash(self.sourceStartLine) + hash(self.sourceEndLine)

    def __str__(self):
        return "SmellInstance:\n" + "Smell:" + self.smellAbbv + "\n" + "Class:" + self.className + "\n" + "Method:" + self.methodName + "\n" +"Field:" + self.field + "\n" + "SourcePath:" + self.sourcePath + "\n" \
    ...
    def setBugAbbv(self,bugAbbv):
        self.smellAbbv=bugAbbv
    def setSmellAbbv(self,smellAbbv):
        self.smellAbbv=smellAbbv
    ...
    def getBugAbbv(self):
        return str(self.smellAbbv)
    def getSmellAbbv(self):
        return str(self.smellAbbv)
